...
func (s *LoginPostReq) GetID() UserId {
	return s.ID
}
...
func (s *LoginPostReq) SetID(val UserId) {
	s.ID = val
}
...
// GetFirstName returns the value of FirstName.
func (s *UserRegisterPostReq) GetFirstName() string {
	return s.FirstName
}

// GetSecondName returns the value of SecondName.
func (s *UserRegisterPostReq) GetSecondName() string {
	return s.SecondName
}

// GetBirthdate returns the value of Birthdate.
func (s *UserRegisterPostReq) GetBirthdate() BirthDate {
	return s.Birthdate
}
...
// GetCity returns the value of City.
func (s *UserRegisterPostReq) GetCity() string {
	return s.City
}

// GetPassword returns the value of Password.
func (s *UserRegisterPostReq) GetPassword() string {
	return s.Password
}

// SetFirstName sets the value of FirstName.
func (s *UserRegisterPostReq) SetFirstName(val string) {
	s.FirstName = val
}

// SetSecondName sets the value of SecondName.
func (s *UserRegisterPostReq) SetSecondName(val string) {
	s.SecondName = val
}

// SetBirthdate sets the value of Birthdate.
func (s *UserRegisterPostReq) SetBirthdate(val BirthDate) {
	s.Birthdate = val
}
...
// SetCity sets the value of City.
func (s *UserRegisterPostReq) SetCity(val string) {
	s.City = val
}

// SetPassword sets the value of Password.
func (s *UserRegisterPostReq) SetPassword(val string) {
	s.Password = val
}
