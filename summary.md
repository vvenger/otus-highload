...
```
- В тестовых данных фамилий больше чем имен, поэтому порядок (second_name, first_name), так как у second_name больше селективность.
